...
var JsonApiDatastore = /** @class */ (function () {
    ...
    JsonApiDatastore.prototype.saveRecord = function (attributesMetadata, model, params, headers, customUrl) {
        ...
        var requestHeaders = this.buildHeaders(headers);
        var relationships = this.getRelationships(model, params);
    ...
    JsonApiDatastore.prototype.getRelationships = function (data, params) {
        var _this = this;
        var relationships;
        var includes = params ? params.include.split(',') : [];
        for (var key in data) {
